...
rclone copy --max-age 10m --no-traverse $HOME/mail/attachments/rosenberg/do iningDropbox:workingDirectory/rosenberg/do >> $HOME/mail/attachments/log/dosync.log 2>&1
